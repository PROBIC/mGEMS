...
void read_probs(const double &theta_frac, const std::vector<double> &abundances, std::istream &probs_file, std::unordered_map<long unsigned, std::vector<bool>> *probs, uint64_t num_ecs);
